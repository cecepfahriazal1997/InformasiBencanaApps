...
import com.informasi.bencana.app.MonitoringActivity;
 ...
 */
public class PatientMonitoringAdapter extends BaseAdapter {
    ...
    public PatientMonitoringAdapter(Activity context, List<PatientMonitoringModel> items, FunctionHelper helper,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.Detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                param.put("title", "List Monitoring Patient");
                ...
                helper.startIntent(MonitoringActivity.class, false, false, param);
            }
        });
