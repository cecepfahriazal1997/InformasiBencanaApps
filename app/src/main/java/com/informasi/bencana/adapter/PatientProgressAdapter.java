...
import com.informasi.bencana.app.ProgressActivity;
 ...
 */
public class PatientProgressAdapter extends BaseAdapter {
    ...
    public PatientProgressAdapter(Activity context, List<PatientProgressModel> items, FunctionHelper helper,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.Detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                param.put("title", "List Progress Patient");
                ...
                helper.startIntent(ProgressActivity.class, false, false, param);
            }
        });
