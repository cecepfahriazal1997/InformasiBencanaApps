...
public class PatientCollabModel {
    private String id, name, doctor, nurse, support, collabId, gender, age, date, year, month, week,
            day, problem, recommend, collaborativeC, collaborativeD, feedback, detailId, phoneDoctor, emailDoctor;
    ...
    public String getCollaborativeC() {
        return collaborativeC;
    }

    public void setCollaborativeC(String collaborativeC) {
        this.collaborativeC = collaborativeC;
    }

    public String getCollaborativeD() {
        return collaborativeD;
    }

    public void setCollaborativeD(String collaborativeD) {
        this.collaborativeD = collaborativeD;
    }
